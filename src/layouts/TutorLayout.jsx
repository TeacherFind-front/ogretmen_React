    ...
    <div className="flex min-h-screen bg-muted/20">
      <aside className="w-72 border-r bg-white hidden md:block shadow-sm">
        ...
        <nav className="p-4 space-y-1">
          <SideLink to="/tutor/dashboard">Panel</SideLink>
          <SideLink to="/tutor/schedule">Takvim</SideLink>
          <SideLink to="/tutor/lessons">Derslerim</SideLink>
          <SideLink to="/tutor/profile">Profilim</SideLink>
          <SideLink to="/tutor/messages">Mesajlar</SideLink>
        </nav>
      </aside>
        ...
        <header className="h-16 border-b bg-white flex items-center px-6 justify-between shadow-sm">
          ...
          <div className="ml-auto flex items-center gap-4">
            <div className="flex flex-col items-end mr-2">
              ...
              <span className="text-xs text-gray-500">Hoş geldin, Hocam</span>
            </div>

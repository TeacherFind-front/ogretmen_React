...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] dark:bg-[var(--page-bg)] transition-colors">
      <ScrollToTop />
      {/* Premium Sidebar */}
      <aside className="w-80 bg-[#0f172a] text-slate-300 hidden lg:flex flex-col border-r border-white/5">
        <div className="p-8">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-green-600 rounded-xl flex items-center justify-center shadow-lg shadow-green-900/20 group-hover:scale-105 transition-transform">
      ...
      <div className="flex-1 flex flex-col min-w-0 pt-16 lg:pt-0">
         <header className="h-20 bg-white dark:bg-[var(--card-bg)] border-b border-slate-100 dark:border-[var(--card-border)] hidden lg:flex items-center px-10 sticky top-0 z-30 transition-colors">
            <div className="flex-1"></div>
           <div className="ml-auto flex items-center gap-4">
              <ThemeSwitch />
              <button className="relative w-10 h-10 flex items-center justify-center text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 bg-slate-50 dark:bg-[var(--card-bg)] rounded-xl transition-all group">
                 <Bell size={18} />
        ...
        <main className="flex-1 p-4 lg:p-10 pb-24 lg:pb-10 bg-[#f8fafc] dark:bg-[var(--page-bg)] transition-colors overflow-x-hidden">
